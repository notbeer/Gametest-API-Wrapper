import { Command, Server, Player } from "../../../library/Minecraft.js";
...
Command.register(registerInformation, (chatmsg, args) => {
    ...
    function sell(item) {
        ...
        sellableItems.some(v => {
            ...
            const itemCount = Player.getItemCount(item ? item : v.item, 0, chatmsg.sender.nameTag)[0]?.count || 0;
    ...
    else return Server.broadcast("§cPlease input an correct argument!", chatmsg.sender.nameTag);
});